	...
	<div class="feedback-form p-l">
		...
		{:else}
			<div class="flex-center text-center">
				<div class="mb-m">
					<svg width="162" height="108" xmlns="http://www.w3.org/2000/svg"
						><g fill="none"
							...
							/><path fill="#61728D" d="M113.172 100.221H51.465L63.651.793h61.706z" /><path
								fill="#181F27"
								d="M110.132 81.354H58.576l8.791-71.695h51.557z"
							/><path fill="#1E252E" d="m92.743 50.055 14.897.177-.29 2.308-14.607-.252z" /><path
								fill="#39475F"
							...
							/><path
								...
								fill="#2D394B"
							/><path fill="#FC7614" d="M5.42 32.843 45.778 0l21.18 26.119L26.603 58.96z" /><path
								fill="#FFF"
							...
							/><path
								...
								fill="#546F8D"
							/><path fill="#2D394B" d="m78.21 14.834-.918 6.041h26.621l.806-6.041z" /><path
								...
								fill="#FFF"
								opacity=".48"
							/><ellipse fill="#FC7614" cx="147.188" cy="81.542" rx="14.812" ry="14.837" /><path
				...
				<p class="bg-gray border-round text-orange ph-m pv-xs">You selected {rating} out of 5</p>
